package com.purusottam.ecommerce.api.exception;
...
public enum ErrorCode {
    ...
    PUBLISHER_NOT_FOUND("Publisher not found", 400), PRODUCT_NOT_FOUND("Product not found", 400), VERSION_NOT_FOUND("Version not found", 400), PRODUCT_EDITION_NOT_FOUND("ProductEdition not found", 400), SYSTEM_REQUIREMENT_NOT_FOUND(
            ...
            401), CATEGORY_NOT_FOUND("Category not found ", 400), CATEGORY_IS_EXIST("Category is exist", 401), SUB_CATEGORY_NOT_FOUND("Sub Category not found ", 400), SUB_CATEGORY_IS_EXIST("Category is exist", 401), USER_IS_EXIST("user is already exist..", 400), USER_IS_NOT_EXIST("User not exist in the DB", 400);
